              ...
              >
                ...
                <v-list-item-title class="product-text center">
                  <v-btn
                    ...
                    small
                    v-if="detalle"
                    :color="detalle.stock ? detalle.stock >= detalle.cantidad ? 'green' : 'red' : 'green lighten-1'"
                ...
                <v-list-item-title class="product-text center">
                  ...
                  <v-btn
                    ...
                    small
                    v-if="detalle"
                    :color="detalle.stock >= detalle.cantidad ? 'green' : 'red'"
...
export default {
  ...
  methods: {
    ...
    calcularTotal(concepto, detalles) {
      ...
      detalles.map((a, i) => {
        suma +=
          this.checkValue(concepto[i].costo_dolar) * a.cantidad * +this.dolar;
